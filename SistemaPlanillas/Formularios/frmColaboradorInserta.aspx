<%@ Page Title="" Language="C#" MasterPageFile="~/Formularios/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="frmColaboradorInserta.aspx.cs" Inherits="SistemaPlanillas.Formularios.frmColaboradorInserta" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContenidoPrincipal" runat="server">
        <form id="form1" runat="server">
        <div>
            <h1>Colaborador Nuevo</h1>
       ...
       <div class="form-group">
          ...
          <asp:CompareValidator ID="cmptxtSalario" runat="server" ErrorMessage="El salario debe ser un numero"  ControlToValidate="txtSalario" Operator="DataTypeCheck" Type="Integer" Display="None"></asp:CompareValidator>
       </div>
